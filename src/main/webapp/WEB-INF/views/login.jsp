...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">
        ...
        <div class="web_login" id="web_login">
            ...
            <div class="login-box">
                ...
                <form:form action="/login" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post" modelAttribute="account">
                        <div class="uinArea" id="uinArea">
                            <label class="input-tips" for="u">帐号：</label>
                            <div class="inputOuter" id="uArea">

                                <input type="text" id="uArea" name="email" class="inputstyle"/>
                            </div>
                        </div>
    ...
    <div class="qlogin" id="qlogin" style="display: none; ">
        ...
        <div class="web_login">
        	<form:form action="/addAccount" name="form2" accept-charset="utf-8" id="regUser"  method="post" modelAttribute="account">
                <ul class="reg_form" id="reg-ul">
                    ...
                    <li>
                        ...
                        <div class="inputOuter2">
                            <input type="text" id="user" name="email" maxlength="16" class="inputstyle2"/>
                        </div>
