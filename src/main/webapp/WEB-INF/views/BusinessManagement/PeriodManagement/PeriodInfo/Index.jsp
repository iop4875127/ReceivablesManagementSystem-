...
<script type="text/javascript"
	src="/assets/js/APP/BusinessManagement/PeriodManagement/PeriodInfo/PeriodInfo.js" ></script>
</head>
<body>
	...
	<div id="mainPanle" data-options="region:'center'" border="false">
		...
		<form action="">
			<div id="cc" data-options="region:'north'" border="false"
				...
				<div class="search-page">
					...
					<div class="warp-from">
						...
						<!--搜索分区线 end-->
						<div class="search_div">
							<div class="search_text">第几分期</div>
							<div class="search_input">
								<input type="text" name="textfield" id="periodLotNo"
			...
			<div data-options="region:'center'" border="false"
				...
				<table class="easyui-datagrid table" id="tblPeriodInfo">
					<thead>
						<tr></tr>
						<tr></tr>
						<tr></tr>
