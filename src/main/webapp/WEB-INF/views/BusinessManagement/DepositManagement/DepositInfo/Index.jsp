...
<script type="text/javascript"
	src="/assets/js/APP/BusinessManagement/DepositManagement/DepositInfo/DepositInfo.js"></script>
</head>
<body>
	...
	<div id="mainPanle" data-options="region:'center'" border="false">
		...
		<form action="">
			<div id="cc" data-options="region:'north'" border="false"
				...
				<div class="search-page">
					...
					<div class="warp-from">
						...
						<!--搜索分区线 end-->
						<div class="search_div">
							<div class="search_text">房屋面积</div>
							<div class="search_input">
								<input type="text" name="textfield" id="area"
									class="input_style input_width input_height">
							</div>
						</div>

						<div class="search_div">
							<div class="search_text">房屋类型</div>
							<div class="search_input">
								<input type="text" name="textfield" id="homeType"
									class="input_style input_width input_height">
							</div>
						</div>
						
						<div class="search_div">
							<div class="search_text">实际两房定金</div>
							<div class="search_input">
								<input type="text" name="textfield" id="realityDeposit"
									class="input_style input_width input_height">
							</div>
						</div>
			...
			<div data-options="region:'center'" border="false"
				...
				<table class="easyui-datagrid table" id="tblDepositInfo">
					<thead>
						<tr></tr>
						<tr></tr>
						<tr></tr>
