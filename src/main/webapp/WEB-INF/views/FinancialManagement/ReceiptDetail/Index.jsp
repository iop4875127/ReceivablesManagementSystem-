...
<script type="text/javascript" src="/assets/js/APP/FinancialManagement/ReceiptDetail/ReceiptInfo.js"></script>
	...
	<div id="mainPanle" data-options="region:'center'" border="false">
		...
		<form action="">
			<div id="cc" data-options="region:'north'" border="false"
				...
				<div class="search-page">
					...
					<div class="warp-from">
						...
						<!--搜索分区线 end-->
						<div class="search_div">
							<div class="search_text">交款姓名</div>
							<div class="search_input">
								<input type="text" name="textfield" id="payName"
			...
			<div data-options="region:'center'" border="false"
				...
				<table class="easyui-datagrid table" id="tblReceiptInfo">
					<thead>
						<tr></tr>
						<tr></tr>
						<tr></tr>
