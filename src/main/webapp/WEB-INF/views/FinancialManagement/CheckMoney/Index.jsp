...
<script type="text/javascript" src="/assets/js/APP/FinancialManagement/CheckMoney/CheckMoneyInfo.js"></script>
</head>
<body>
	...
	<div id="mainPanle" data-options="region:'center'" border="false">
		...
		<form action="">
			...
			<div data-options="region:'center'" border="false"
				...
				<table class="easyui-datagrid table" id="tblCkeckMoneyInfo">
					<thead>
						<tr></tr>
						<tr></tr>
						<tr></tr>
