...
<script type="text/javascript"
	src="/assets/js/APP/HumanResourcesManagement/EmployeeManagement/EmployeeInfo/EmployeeInfo.js"></script>
</head>
<body>
	...
	<div id="mainPanle" data-options="region:'center'" border="false">
		...
		<form action="">
			<div id="cc" data-options="region:'north'" border="false"
				...
				<div class="search-page">
					...
					<div class="warp-from">
						...
						<div class="search_div">
							<div class="search_text">编号</div>
							<div class="search_input">
								<input type="text" name="textfield" id="employeeNo"
									class="input_style input_width input_height">
							</div>
						</div>
						
						<div class="search_div">
							<div class="search_text">部门</div>
							<div class="search_input">
								<input type="text" name="textfield" id="department"
									class="input_style input_width input_height">
							</div>
						</div>
						
						<div class="search_div">
							<div class="search_text">职位</div>
							<div class="search_input">
								<input type="text" name="textfield" id="position"
									class="input_style input_width input_height">
							</div>
						</div>
			...
			<div data-options="region:'center'" border="false"
				...
				<table class="easyui-datagrid table" id="tblEmployeeInfo">
					<thead>
						<tr></tr>
						<tr></tr>
						<tr></tr>
